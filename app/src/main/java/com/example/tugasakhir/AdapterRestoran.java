...
public class AdapterRestoran extends RecyclerView.Adapter<AdapterRestoran.ViewHolder>{
    ...
    AdapterRestoran(ArrayList<String> arrayList, ArrayList<Integer> memeList){
            ...
            ItemList.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    switch (getAdapterPosition()){
                        case 0 :
                            intent = new Intent(context, DetailRestoran1.class);
                            break;
                        case 1 :
                            intent = new Intent(context, DetailRestoran2.class);
                            break;
                        case 2 :
                            intent = new Intent(context, DetailRestoran3.class);
                            break;
                        case 3 :
                            intent = new Intent(context, DetailRestoran4.class);
                            break;
                        case 4 :
                            intent = new Intent(context, DetailRestoran5.class);
                            break;
                    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View V = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_listguide, parent, false);
