...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.ViewHolder>{
    ...
    RecyclerAdapter(ArrayList<String> arrayList, ArrayList<Integer> memeList){
            ...
            ItemList.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    switch (getAdapterPosition()){
                        case 0 :
                            intent = new Intent(context, DetailGuide1.class);
                            break;
                        case 1 :
                            intent = new Intent(context, DetailGuide2.class);
                            break;
                        case 2 :
                            intent = new Intent(context, DetailGuide3.class);
                            break;
                        case 3 :
                            intent = new Intent(context, DetailGuide4.class);
                            break;
                        case 4 :
                            intent = new Intent(context, DetailGuide5.class);
                            break;
                    }
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.SubMeme.setText("Saya Adalah Pemandu Wisata Professional");
