...
public class AdapterHotel extends RecyclerView.Adapter<AdapterHotel.ViewHolder>{
    ...
    AdapterHotel(ArrayList<String> arrayList, ArrayList<Integer> memeList){
            ...
            ItemList.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    switch (getAdapterPosition()){
                        case 0 :
                            intent = new Intent(context, DetailHotel.class);
                            break;
                        case 1 :
                            intent = new Intent(context, DetailHotel2.class);
                            break;
                        case 2 :
                            intent = new Intent(context, DetailHotel3.class);
                            break;
                        case 3 :
                            intent = new Intent(context, DetailHotel4.class);
                            break;
                        case 4 :
                            intent = new Intent(context, DetailHotel5.class);
                            break;
                    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View V = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_listhotel, parent, false);
